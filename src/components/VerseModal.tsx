...
export const VerseModal: React.FC<VerseModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-md" dir={isRtl ? 'rtl' : 'ltr'}>
      <div className="relative w-full max-w-lg glass-panel rounded-3xl border border-amber-500/30 p-5 sm:p-7 shadow-2xl shadow-amber-950/50 text-slate-100 overflow-hidden">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-800/80">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-base font-bold gold-gradient-text">{t.dailyPromise}</h3>
        ...
        {/* Image Banner */}
        <div className="relative w-full h-32 rounded-2xl overflow-hidden my-3 border border-amber-500/30">
          <img 
          ...
          <div className="absolute bottom-2 left-3 right-3 flex items-center justify-between">
            ...
            <span className="text-xs text-slate-300 bg-slate-950/70 px-2 py-0.5 rounded-md backdrop-blur-sm">
              {currentIndex + 1} {t.verseOf} {DAILY_VERSES.length}
            </span>
          </div>
        </div>
        ...
        <div className="py-2 space-y-3">
          ...
          <blockquote className="text-sm sm:text-base font-serif italic text-amber-100/95 leading-relaxed bg-amber-950/25 p-4 rounded-2xl border-l-4 border-amber-500">
            "{currentVerse.text}"
          </blockquote>

          {/* Reference */}
          <p className="text-xs sm:text-sm font-semibold text-amber-400 text-right">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 border-t border-slate-800/80">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title={isPlayingAudio ? t.pause : t.listen}
            >
